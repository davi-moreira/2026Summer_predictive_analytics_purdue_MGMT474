...
The Summer 2026 offering of **QM47400 (Predictive Analytics)** ran from **May 18 to June 12, 2026**, with students wrapping up their final activities by **June 14**. I first drafted this page mid-stream, as a field journal, while I was still building material. I am finalizing it now that the course has fully run, start to finish: every notebook delivered, the midterm and quizzes given, and the term brought to a close. So what follows is no longer a forecast of how I expected the workflow to go. It is an honest account of how it actually went: what worked, what cost me time, and what I would tell a colleague before they start. Working with [Claude Code](https://www.anthropic.com/claude-code) as an AI co-designer changed how I build a course, and the techniques that mattered most by the end are not the ones I would have predicted at the start.
:::
...
The same discipline extends to **assignments and their grading rubrics**: each milestone and the case competition has a plain-text specification with its rubric, so the criteria students are handed are the criteria they are evaluated against, and the assistant can keep an assignment, its rubric, and the schedule in sync. One firm boundary comes with this: **anything that identifies a student — rosters, submissions, grades, filled-in rubrics — must be set up under FERPA from the very start.** In this repo that means all of it lives in a gitignored admin tree, with the task tracker in a private companion repo, never in the public-facing repository or its history. A candid note on the grading itself: my use of agentic AI to actually *score* student work this round was marginal — I leaned on it to draft rubrics and scaffold the bookkeeping, not to assign grades — but it is a direction I deliberately want to explore more deeply in future offerings.
